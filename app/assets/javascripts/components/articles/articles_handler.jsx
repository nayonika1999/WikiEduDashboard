    ...
    return (
      <div className="articles-view">
          ...
          <ul>
            ...
            <li>
              <NavLink
                ...
                activeClassName="active"
                disabled={this.hideAssignments()}
                className={`button ${this.hideAssignments() ? 'disabled' : ''}`}
              >
                {this.hideAssignments() ? I18n.t('articles.no_available') : I18n.t('articles.available') }
              </NavLink>
            </li>
          </ul>
        </nav>
        ...
        <Switch>
          ...
          />
          <Redirect to="/courses/:course_school/:course_title/articles/edited" />
        </Switch>
